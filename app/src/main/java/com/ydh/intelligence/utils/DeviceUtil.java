...
public class DeviceUtil {
    ...
    public static String getMemoryInfo() {
        //获取运行内存的信息
        ActivityManager manager = (ActivityManager) BaseApplication.getContext().getSystemService(Context.ACTIVITY_SERVICE);
        ActivityManager.MemoryInfo info = new ActivityManager.MemoryInfo();
        manager.getMemoryInfo(info);
        StringBuilder sb = new StringBuilder();
        sb.append("可用:");
        sb.append(Formatter.formatFileSize(BaseApplication.getContext(), info.availMem));
        sb.append(", 全部:");
        sb.append(Formatter.formatFileSize(BaseApplication.getContext(), info.totalMem));
        return sb.toString();
    }
    ...
    public static String getAvailSDSize() {
        try {
            ...
            return Formatter.formatFileSize(BaseApplication.getContext(), availsd);
        } catch (Exception e) {
        }
        return "get no data";
    }
