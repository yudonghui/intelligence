...
public class Strings {
    ...
    public static String getSecretName(String string) {
        if (TextUtils.isEmpty(string) || "null".equals(string)) {
            return "";
        }
        if (string.length() > 1) {
    ...
    public static SpannableString getSpannable(String text1, int resId1, int size,String text2, int resId2) {
        ...
        spannableString.setSpan(new AbsoluteSizeSpan(size), 0, text1.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
