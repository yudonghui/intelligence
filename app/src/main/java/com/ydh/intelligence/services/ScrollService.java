...
public class ScrollService extends BaseService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        durationTime = SPUtils.getCacheL(SPUtils.FILE_USER, SPUtils.DURATION) == 0 ? 5000 : SPUtils.getCacheL(SPUtils.FILE_USER, SPUtils.DURATION);
        orientation = SPUtils.getCacheInt(SPUtils.FILE_USER, SPUtils.ORIENTATION);
